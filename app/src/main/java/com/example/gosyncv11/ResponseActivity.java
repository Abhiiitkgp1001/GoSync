...
public class ResponseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_response = findViewById(R.id.linearLayout_response_show);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    for(int i=0;i<response_form_no;i++){
                        ...
                        form_no_btn.setText("Response "+(i+1));
                        ll_response.addView(view);
                        int finalI = i;
                        form_no_btn.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent = new Intent(ResponseActivity.this,ResponseFormActivity.class);
                                intent.putExtra("ResponseID",finalI+1);
